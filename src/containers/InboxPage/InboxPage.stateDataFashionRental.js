...
// Get UI data mapped to specific transaction state & role for the
// fashion-rental process (purchase-shaped with manual capture:
// preauthorized payments the provider accepts or declines).
